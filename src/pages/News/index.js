    ...
    <div className="root">
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="mb-8">
            <ul className="list-reset flex items-center border-b">
              ...
              {_.range(0, 6).map((item) => (
                <li key={item} className="-mb-px mr-2">
                  <a
                    className="bg-white border border-solid no-underline inline-block rounded-3xl py-2 px-4 text-blue-dark hover:text-blue-darker active:bg-blue-800 font-semibold"
                    href="/news"
                  >
                    Real Estate
                  </a>
